...
export default function ScorePage() {
  ...
  const strokeDashoffset = circumference - (ratefluencerScore.composite / 100) * circumference;
        ...
        <div className="relative z-10 mx-auto max-w-2xl">
          ...
          <div className="relative mx-auto flex size-72 items-center justify-center">
            ...
            <div className="text-center">
              <motion.span className="text-7xl font-bold tracking-tighter text-white">
                {roundedScore}
              </motion.span>
          ...
          <p className="mt-6 text-lg font-medium text-zinc-300">
            Top <span className="text-emerald-400 font-bold">{100 - ratefluencerScore.percentile}%</span> of all analyzed influencers
          </p>
        </div>
      </motion.div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        >
          ...
          <div className="mt-4 flex justify-center gap-6 text-xs text-zinc-400">
            <div className="flex items-center gap-2">
              <div className="size-3 rounded-sm bg-violet-500/40 border border-violet-500"></div>
              <span>This Influencer</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="size-3 rounded-sm bg-zinc-600/30 border border-zinc-500"></div>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
        ...
        >
          ...
          <ul className="space-y-3">
            {ratefluencerScore.strengths.map((s) => (
        ...
        >
          ...
          <ul className="space-y-3">
            {ratefluencerScore.improvementAreas.map((w) => (
        ...
        >
          ...
          <div className="space-y-3">
            {ratefluencerScore.comparableInfluencers.map((comp) => (
