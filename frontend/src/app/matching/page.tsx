...
import { allIndustries } from "@/data/brands";
import type { SortOption } from "@/types";

export default function BrandMatchingPage() {
  const { data: brandMatches, isError, isFetching } = useBrands();
  ...
  const filteredAndSortedBrands = useMemo(() => {
    ...
    return result;
  }, [brandMatches, selectedIndustries, sortOption]);
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            >
              <div className="flex items-start justify-between mb-6">
                ...
                <div className="shrink-0">
                  <ScoreRing score={brand.matchScore} size={64} strokeWidth={6} labelSuffix="%" className="text-lg" />
                </div>
              </div>
              ...
              <div className="mt-6 border-t border-zinc-800 pt-5">
                <Button variant="ghost" className="w-full justify-between text-zinc-400 hover:text-zinc-100 hover:bg-zinc-800/50">
                  View Match Details
          ...
          {filteredAndSortedBrands.length === 0 && (
            <div className="col-span-full flex flex-col items-center justify-center rounded-xl border border-dashed border-zinc-800 py-16 text-center">
              ...
              <Button variant="outline" onClick={() => setSelectedIndustries([])}>Clear Filters</Button>
            </div>
          )}
        </div>
      )}
